...
end_date = datetime.strptime('1985-06-09', '%Y-%m-%d')
...
df.to_csv('broadway_grosses_historical.csv', index=False)
logging.info("Data saved to broadway_grosses_historical.csv")
